...
let desc = encodeURIComponent(window.ENCODE_URI_COMPONENT_DESC);
...
function dofristshare(type) {
    ...
    if (type == "qq") {
        window.open("//connect.qq.com/widget/shareqq/index.html?url=" + link + "&title=" + title + "&desc=" + desc + "&pics=" + image + "&site=" + site);
    }
    if (type == "qzone") {
